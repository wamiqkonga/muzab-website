  ...
  useEffect(() => {
    ...
    api.get(`/api/products/${slug}`)
      .then((res) => {
        ...
        setPageMeta(
          p.name,
          p.description || `Buy ${p.name} online — premium Kashmiri saffron & natural products from Muzab.`,
          { path: `/products/${slug}`, image: p.images?.[0] }
        );
      })
  ...
  return (
    <div className="min-h-screen bg-linen">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        {/* ── Specifications (saffron only — these values don't apply to skincare) ── */}
        ...
        {/* ── What Makes Saffron Powerful (saffron only) ── */}
        {product.category === 'Saffron' && (
        ...
        {/* ── Authenticity check (saffron only) ── */}
        {product.category === 'Saffron' && (
          <section className="mt-8 bg-white rounded-xl border border-linen p-6">
